var GmApi = {
    ...
    gmGoHome : function()
    {
        this.callCSharpHandler("GoHome", null, []);
    },

    gmUpdateTitle : function(title)
    {
        this.callCSharpHandler("UpdateTabTitle", null, [title]);
    },

    gmShowApp : function(displayName, packageName, activityName, apkUrl)
    {
